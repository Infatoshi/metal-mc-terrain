#!/bin/bash
# SkyFactory One - Native ARM64 + ZGC (the endgame)
# arm64 Java 17 + LWJGL 3.3.1 arm64 + ZGC (<1ms pauses, native)
# No Rosetta. No translation overhead. Native Metal GPU driver.
