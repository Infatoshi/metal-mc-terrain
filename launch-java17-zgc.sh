#!/bin/bash
# SkyFactory One - Java 17 x86_64 + ZGC launcher
# ZGC: <1ms GC pauses (vs 264ms worst with G1GC)
# Auto-refreshes Microsoft auth token via refresh_token.py

set -e

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
JAVA="/Users/infatoshi/java/jdk-17.0.18+8/Contents/Home/bin/java"
